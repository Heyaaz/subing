...
export const getServiceById = async (serviceId) => {
  const response = await api.get(`/api/v1/admin/services/${serviceId}`);
  return response.data;
};
...
export const updateService = async (serviceId, data) => {
  const response = await api.put(`/api/v1/admin/services/${serviceId}`, data);
  return response.data;
};
...
export const getPlansByServiceId = async (serviceId) => {
  const response = await api.get(`/api/v1/admin/plans/service/${serviceId}`);
  return response.data;
};
